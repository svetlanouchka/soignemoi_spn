    ...
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
        ...
        <div class="col-lg-6 order-md-1">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                <a href="https://soignemoi-spn.fly.dev/studi_ecf/soignemoi_spn/index.php?controller=sejour&action=create" class="btn btn-primary btn-lg px-4 me-md-2">Créer votre séjour</a>
            </div>
        </div>
    </div>
</div>
